...
<head>
    ...
    <link href="csseshop/noidungtrangchu.css" rel="stylesheet">
...
?>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="#"><i class="fa fa-envelope"></i> hatb2003736@student.ctu.edu.vn</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div>
                    <div class="col-sm-6">
                        <div class="logo pull-left">
                            <a href="index.php" style="background-color:#069;color:#FFF">ITFOUR <img
                    ...
                    <div class="col-sm-6">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                 <!--Cap nhat hoa don dat hang-->
                                <li><a href="?khoatrang=giohang" style="background-color:#069;color:#FFF"><i
                                            class="fa fa-shopping-cart" aria-hidden="true"></i> Giỏ hàng <span
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Giới thiệu<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="?khoatrang=tintuc">Tin Tức</a></li>
	...
	if(isset($_GET['khoatrang'])){
		...
		elseif($khoatrang=="hienthi_sanpham"){
			include_once("hiethi_sanpham.php");
		}
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>IT<span>FOUR</span></h2>
                        <p>Nhóm ITFour bất ổn</I></p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        <h2 class="footer-wid-title">ITFour</h2>
                        <p>Tôi bị ép tạo website này</p>
                            <div class="footer-social">
                            <a href="#" target="_blank"><i class="fa fa-facebook"></i></a>
                            <a href="#" target="_blank"><i class="fa fa-twitter"></i></a>
                            <a href="#" target="_blank"><i class="fa fa-youtube"></i></a>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy;LNH <a href="https://www.facebook.com/profile.php?id=100035508373396"
   ...
   <!-- <script type="text/javascript" src="js/bxslider.min.js"></script>
    <script type="text/javascript" src="js/script.slider.js"></script>
                        -->
    <script type="text/javascript" src="js/noidungtrangchu.js"></script>
