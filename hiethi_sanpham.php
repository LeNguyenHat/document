...
function dathang($ma,$conn)
	{
			$ma = $_GET["ma"];
			$resultsql = mysqli_query($conn, "SELECT a.*, b.nsx_ten, c.soluong FROM sanpham a join nhasanxuat b on a.nsx_ma= b.nsx_ma
			join chitiet_lonhap c  on c.lonhap_ma=a.lonhap_ma;
									WHERE sp_ma = ".$ma);
            ...
            <div class="col-sm-4">
                <div class="latest-product">
                    ...
                    <div class="product-carousel">
                        ...
                        <!--Load san pham tu DB -->
                        <?php
		  				   	$result = mysqli_query($conn, "SELECT a.*,(SELECT b.hsp_tentaptin as sp_hinhdaidien FROM hinhsanpham b 
								 WHERE a.sp_ma = b.sp_ma LIMIT 0,1) 
								 FROM sanpham a ORDER BY sp_ma " );
