...
function bindLSPList($conn) {
    ...
    if(isset($_POST["btnThemMoi"]))
    {
            ...
            else
            {
                ...
                {
                    $sqlstring = "INSERT INTO sanpham ( sp_ten, sp_mota_ngan,sp_mota_chitiet,sp_gia,lsp_ma,nsx_ma, sp_ngaycapnhat,lonhap_ma)
                        VALUES('".$ten."','".$motangan."','".$motachitiet."','".$gia."' ,'".$loai."','".$nsx."','".date('Y-m-d H:i:s')."','".$lonhap."')";
     ...
     <form id="form1" name="form1" method="post" action="" class="form-horizontal" role="form">
        <div class="form-group">
          ...
          <script language="javascript">
                        ...
                        <div class="form-group">   
                        <label for="lbllonhap" class="col-sm-2 control-label">Mã Lô Nhập (*):  </label>
                        <div class="col-sm-10">
                              <input type="text" name="txtlonhap" id="txtlonhap" class="form-control" placeholder="Mã lô nhập" value=''/>
                        </div>
                        </div>
                    </div>
                <div class="form-group">
